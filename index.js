...
if ((isMedia && !hexa.message.videoMessage || isQuotedImage || isQuotedSticker) && args.length > 0) {
ger = isQuotedImage || isQuotedSticker ? JSON.parse(JSON.stringify(hexa).replace('quotedM','m')).message.extendedTextMessage.contextInfo : hexa
