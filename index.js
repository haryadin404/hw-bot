...
encmedia = isQuotedImage || isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
...
break
case 'idih':
	const Haikal9 = fs.readFileSync('./stik/bacotah.jpeg')
hexa.sendMessage(from,Haikal9,image,{mimetype: Mimetype.image,quoted : mek, thumbnail: fs.readFileSync('./stik/awokwok.jpeg')})
break      
